...
1,5,1,5,0,0,6,0,2,4,6,8,10,0,1,2,0,3,4,6,6,39,0,12,1,0,0,0,2,21,1,0,0,0,
4,24,1,0,0,0,6,33,1,0,0,0,8,36,1,0,0,0,10,41,1,0,0,0,12,13,5,1,0,0,13,14,
5,5,0,0,14,15,5,7,0,0,15,16,3,2,1,0,16,17,5,8,0,0,17,1,1,0,0,0,18,20,3,4,
2,0,19,18,1,0,0,0,20,23,1,0,0,0,21,19,1,0,0,0,21,22,1,0,0,0,22,3,1,0,0,0,
23,21,1,0,0,0,24,25,5,2,0,0,25,26,5,5,0,0,26,27,5,7,0,0,27,28,3,6,3,0,28,
29,5,8,0,0,29,5,1,0,0,0,30,32,3,8,4,0,31,30,1,0,0,0,32,35,1,0,0,0,33,31,
1,0,0,0,33,34,1,0,0,0,34,7,1,0,0,0,35,33,1,0,0,0,36,37,5,5,0,0,37,38,5,9,
0,0,38,39,3,10,5,0,39,40,5,10,0,0,40,9,1,0,0,0,41,42,7,0,0,0,42,11,1,0,0,
0,2,21,33];
...
export default class ConfiguracionGrammarParser extends antlr4.Parser {
    ...
    static literalNames = [ null, "'configuracion'", "'seccion'", null, 
                            null, null, null, "'{'", "'}'", "'='", "';'" ];
	...
	configuracion() {
	    ...
	    try {
	        ...
	        this.state = 12;
	        this.match(ConfiguracionGrammarParser.CONFIG);
	        this.state = 13;
	        this.match(ConfiguracionGrammarParser.ID);
	        this.state = 14;
	        this.match(ConfiguracionGrammarParser.LLAVE_ABIERTA);
	        this.state = 15;
	        this.secciones();
	        this.state = 16;
	        this.match(ConfiguracionGrammarParser.LLAVE_CERRADA);
	    } catch (re) {
	...
	seccion() {
	    ...
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 24;
	        this.match(ConfiguracionGrammarParser.SECCION);
	        this.state = 25;
	        this.match(ConfiguracionGrammarParser.ID);
	        this.state = 26;
	        this.match(ConfiguracionGrammarParser.LLAVE_ABIERTA);
	...
	parametro() {
	    ...
	    try {
	        ...
	        this.match(ConfiguracionGrammarParser.ID);
	        this.state = 37;
	        this.match(ConfiguracionGrammarParser.IGUAL);
	        this.state = 38;
	        this.valor();
	        this.state = 39;
	        this.match(ConfiguracionGrammarParser.PUNTO_Y_COMA);
	    } catch (re) {
	    	if(re instanceof antlr4.error.RecognitionException) {
		        localctx.exception = re;
		        this._errHandler.reportError(this, re);
...
ConfiguracionGrammarParser.CONFIG = 1;
ConfiguracionGrammarParser.SECCION = 2;
ConfiguracionGrammarParser.BOOLEANO = 3;
ConfiguracionGrammarParser.CADENA = 4;
ConfiguracionGrammarParser.ID = 5;
ConfiguracionGrammarParser.NUM = 6;
ConfiguracionGrammarParser.LLAVE_ABIERTA = 7;
ConfiguracionGrammarParser.LLAVE_CERRADA = 8;
ConfiguracionGrammarParser.IGUAL = 9;
ConfiguracionGrammarParser.PUNTO_Y_COMA = 10;
...
class ConfiguracionContext extends antlr4.ParserRuleContext {
	...
	CONFIG() {
	    return this.getToken(ConfiguracionGrammarParser.CONFIG, 0);
	};
	...
	LLAVE_ABIERTA() {
	    return this.getToken(ConfiguracionGrammarParser.LLAVE_ABIERTA, 0);
	};
	...
	LLAVE_CERRADA() {
	    return this.getToken(ConfiguracionGrammarParser.LLAVE_CERRADA, 0);
	};
...
class SeccionContext extends antlr4.ParserRuleContext {
	...
	SECCION() {
	    return this.getToken(ConfiguracionGrammarParser.SECCION, 0);
	};
...
class ParametroContext extends antlr4.ParserRuleContext {
	...
	IGUAL() {
	    return this.getToken(ConfiguracionGrammarParser.IGUAL, 0);
	};
	...
	PUNTO_Y_COMA() {
	    return this.getToken(ConfiguracionGrammarParser.PUNTO_Y_COMA, 0);
	};
